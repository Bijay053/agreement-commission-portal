...
- **Feature Specifications**:
    ...
    - **Employee Management**: CRUD for employee profiles, employment agreements (with e-signature and PDF generation), and offer letters, all with multi-status workflows and secure document handling.
