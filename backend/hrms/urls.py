...
urlpatterns = [
    ...
    path('hrms/leave-requests/<uuid:lr_id>/cancel', views.AdminLeaveRequestCancelView.as_view()),
    ...
    path('hrms/leave-requests/upload-document', views.LeaveDocumentUploadView.as_view()),
