...
class AgreementCommissionRule(models.Model):
    ...
    followup_study_level = models.CharField(max_length=255, null=True, blank=True)
    followup_commission_mode = models.CharField(max_length=16, null=True, blank=True)
    followup_percentage_value = models.DecimalField(max_digits=6, decimal_places=3, null=True, blank=True)
