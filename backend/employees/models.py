...
class Employee(models.Model):
    ...
    week_off_days = models.JSONField(null=True, blank=True, help_text='List of week-off day numbers: 0=Mon..6=Sun, e.g. [5,6] for Sat+Sun')
    work_start_time = models.TimeField(null=True, blank=True, help_text='Override department work start time')
    work_end_time = models.TimeField(null=True, blank=True, help_text='Override department work end time')
