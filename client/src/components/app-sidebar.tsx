...
import {
  ...
  ChevronDown, ChevronRight, Circle, KeyRound, Contact, DollarSign, Calculator, ShieldCheck, ArrowDownUp, ClipboardList, UserCheck, Share2, SlidersHorizontal, Briefcase, ClipboardCheck,
} from "lucide-react";
...
export function AppSidebar() {
  ...
  const adminNav = [
    ...
    { title: "Surveys", url: "/surveys", icon: ClipboardCheck, show: hasPermission("survey.view") },
    ...
    <Sidebar collapsible="icon">
      ...
      <SidebarContent>
        ...
        {employeeNav.some(i => i.show) && (
          <SidebarGroup>
            <SidebarGroupLabel className="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground/70">People & HRMS</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
