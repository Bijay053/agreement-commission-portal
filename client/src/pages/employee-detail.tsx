...
const AGREEMENT_STATUSES: Record<string, { label: string; color: string }> = {
  ...
  employee_signed: { label: 'Employee Signed', color: 'bg-orange-50 text-orange-700 border-orange-200' },
  signed: { label: 'Fully Signed', color: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
